...
OPENCODE_ROUTER_REPO="${OPENCODE_ROUTER_REPO:-https://github.com/Apnium Technology/antonic-agent.git}"
OPENCODE_ROUTER_INSTALL_DIR="${OPENCODE_ROUTER_INSTALL_DIR:-$HOME/.antonic-agent/opencode-router/antonic-agent}"
...
Environment variables:
  OPENCODE_ROUTER_INSTALL_DIR  Install directory (default: ~/.antonic-agent/opencode-router/antonic-agent)
  OPENCODE_ROUTER_REPO         Git repo (default: https://github.com/Apnium Technology/antonic-agent.git)
...
Example:
  OPENCODE_ROUTER_INSTALL_DIR=~/opencode-router curl -fsSL https://raw.githubusercontent.com/Apnium Technology/antonic-agent/dev/packages/opencode-router/install.sh | bash
EOF
}
