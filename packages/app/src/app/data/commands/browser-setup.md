---
name: browser-setup
description: Guide the user through browser automation setup in Antonic Agent
---

Help the user set up browser automation in Antonic Agent.
...
1) Are you using the Antonic Agent desktop app, or the web app?
...
2) If they want the OpenCode Browser path:
   - Tell them where to check in Antonic Agent (Plugins tab) and what "connected" looks like.
