/**
 * 中文（简体）翻译
 * 专业术语不翻译：Skills、Plugins、Commands、Sessions、OpenCode、OpenPackage、Antonic Agent、MCPs
 */
...
export default {
  ...
  "dashboard.hero_description": "描述一个目标。Antonic Agent 将运行它并保留审计记录。",
  ...
  "dashboard.create_remote_workspace_subtitle": "保存 Antonic Agent 服务器为工作区。",
  "dashboard.create_remote_workspace_confirm": "添加工作区",
  "dashboard.edit_remote_workspace_title": "编辑远程连接",
  "dashboard.edit_remote_workspace_subtitle": "更新此工作区的 Antonic Agent 服务器信息。",
  "dashboard.edit_remote_workspace_confirm": "保存连接",
  "dashboard.remote_workspace_title": "远程工作区",
  "dashboard.remote_workspace_hint": "记录 Antonic Agent 服务器，随时重新连接。",
  "dashboard.remote_base_url_label": "Antonic Agent 服务器地址",
  "dashboard.remote_base_url_placeholder": "http://127.0.0.1:8787",
  "dashboard.remote_base_url_required": "请先填写服务器地址。",
  "dashboard.openwork_host_label": "Antonic Agent 服务器地址",
  "dashboard.openwork_host_placeholder": "https://your-server.openwork.app",
  "dashboard.openwork_host_hint": "使用 Antonic Agent 服务器提供的地址。",
  ...
  "dashboard.remote_mode_openwork_alpha": "Antonic Agent 服务器",
  ...
  "session.placeholder": "向 Antonic Agent 提问...",
  "session.run": "运行",
  ...
  "skills.host_only_error": "技能管理需要本地工作区或已连接的 Antonic Agent 服务器。",
  ...
  "skills.connect_host_to_load": "连接 Antonic Agent 服务器以加载技能。",
  ...
  "mcp.mcps_title": "MCPs",
  "mcp.connect_mcp_hint": "连接 MCP 服务器以扩展 Antonic Agent 的功能。",
  ...
  "mcp.mcps_label": "MCPs",
  "mcp.mcps_description": "连接 MCP 服务器以扩展 Antonic Agent 的功能。",
  "mcp.configured": "已配置",
  "mcp.updated": "更新时间",
  ...
  "mcp.auth.step2_title": "授权 Antonic Agent",
  ...
  "settings.done": "完成",
  "settings.updates": "更新",
  "settings.updates_description": "保持 Antonic Agent 为最新版本。",
  ...
  "settings.advanced_description": "重置 Antonic Agent 本地状态以重新测试入门流程。",
  ...
  "settings.reset_confirmation_hint": "输入 <span class=\"font-mono\">RESET</span> 以确认。Antonic Agent 将重启。",
  "settings.reset_onboarding_warning": "清除 Antonic Agent 本地偏好设置和工作区入门标记。",
  "settings.reset_app_data_warning": "清除此设备上的 Antonic Agent 缓存和应用数据。",
  ...
  "settings.updates_hint": "保持 Antonic Agent 为最新版本。",
  ...
  "settings.advanced_hint": "重置 Antonic Agent 本地状态以重新测试入门流程。",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "正在启动 Antonic Agent 服务器...",
  "onboarding.searching_host": "正在连接 Antonic Agent 服务器...",
  ...
  "onboarding.start": "启动 Antonic Agent",
  "onboarding.back": "返回",
  ...
  "onboarding.windows_install_instruction": "安装 Windows 版 OpenCode，然后重启 Antonic Agent。确保 opencode.exe 在 PATH 中。",
  ...
  "onboarding.cli_install_commands": "使用以下命令之一安装 OpenCode，然后重启 Antonic Agent。",
  ...
  "onboarding.remote_workspace_title": "连接 Antonic Agent 服务器",
  "onboarding.remote_workspace_description": "连接 Antonic Agent 服务器以随时访问工作区。",
  "onboarding.remote_workspace_action": "连接",
  "onboarding.remote_workspace_card_title": "连接远程工作区",
  "onboarding.remote_workspace_card_description": "连接 Antonic Agent 服务器以访问共享工作区。",
  "onboarding.advanced_openwork_host": "Antonic Agent 服务器",
  ...
  "onboarding.welcome_title": "今天想如何运行 Antonic Agent？",
  "onboarding.run_local": "本地运行",
  "onboarding.run_local_description": "Antonic Agent 在本地运行 OpenCode 并保持您的工作私密。",
  ...
  "onboarding.default_workspace_path": "~/Antonic Agent/Workspace",
  ...
  "app.migration.restart_failed": "迁移已完成，但 Antonic Agent 无法重启本地引擎。",
