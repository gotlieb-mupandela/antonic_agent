 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage, Antonic Agent) are NOT translated
 */
...
export default {
  ...
  "dashboard.hero_description": "Describe an outcome. Antonic Agent will run it and keep an audit trail.",
  ...
  "dashboard.create_remote_workspace_subtitle": "Save an Antonic Agent server as a worker.",
  "dashboard.create_remote_workspace_confirm": "Add Worker",
  "dashboard.edit_remote_workspace_title": "Edit Remote Connection",
  "dashboard.edit_remote_workspace_subtitle": "Update the Antonic Agent server details for this worker.",
  "dashboard.edit_remote_workspace_confirm": "Save connection",
  "dashboard.remote_workspace_title": "Remote worker",
  "dashboard.remote_workspace_hint": "Track an Antonic Agent server and reconnect anytime.",
  "dashboard.remote_base_url_label": "Antonic Agent server URL",
  "dashboard.remote_base_url_placeholder": "http://127.0.0.1:8787",
  "dashboard.remote_base_url_required": "Add a server URL to continue.",
  "dashboard.openwork_host_label": "Antonic Agent server URL",
  "dashboard.openwork_host_placeholder": "https://your-server.openwork.app",
  "dashboard.openwork_host_hint": "Use the URL shared by your Antonic Agent server.",
  ...
  "dashboard.remote_mode_openwork_alpha": "Antonic Agent server",
  "dashboard.remote_mode_direct": "Direct (legacy)",
  "dashboard.remote_connection_openwork": "Antonic Agent",
  ...
  "session.placeholder": "Ask Antonic Agent...",
  "session.run": "Run",
  ...
  "skills.host_only_error": "Skill management requires a local worker or connected Antonic Agent server.",
  ...
  "skills.connect_host_to_load": "Connect an Antonic Agent server to load skills.",
  ...
  // ==================== Apps (MCP) ====================
  "mcp.apps_title": "Apps",
  "mcp.apps_subtitle": "Connect your favorite tools so Antonic Agent can use them on your behalf.",
  ...
  "mcp.mcps_title": "Apps",
  "mcp.connect_mcp_hint": "Connect apps to expand what Antonic Agent can do.",
  ...
  "mcp.mcps_label": "Apps",
  "mcp.mcps_description": "Connect apps to expand what Antonic Agent can do.",
  ...
  "mcp.auth.step2_title": "Authorize Antonic Agent",
  ...
  "settings.updates_description": "Keep Antonic Agent up to date.",
  ...
  "settings.advanced_description": "Reset Antonic Agent local state to retest onboarding.",
  "settings.reset_onboarding": "Reset onboarding",
  "settings.reset_onboarding_description": "Clears Antonic Agent preferences and restarts the app.",
  "settings.reset_app_data": "Reset app data",
  "settings.reset_app_data_description": "More aggressive. Clears Antonic Agent cache + app data.",
  ...
  "settings.reset_confirmation_hint": "Type <span class=\"font-mono\">RESET</span> to confirm. Antonic Agent will restart.",
  "settings.reset_onboarding_warning": "Clears Antonic Agent local preferences and worker onboarding markers.",
  "settings.reset_app_data_warning": "Clears Antonic Agent cache and app data on this device.",
  ...
  "settings.updates_hint": "Keep Antonic Agent up to date.",
  ...
  "settings.advanced_hint": "Reset Antonic Agent local state to retest onboarding.",
  "settings.reset_onboarding_label": "Reset onboarding",
  "settings.reset_onboarding_hint": "Clears Antonic Agent preferences and restarts the app.",
  "settings.reset_app_data_label": "Reset app data",
  "settings.reset_app_data_hint": "More aggressive. Clears Antonic Agent cache + app data.",
  ...
  // ==================== Onboarding ====================
  "onboarding.starting_host": "Starting Antonic Agent server...",
  "onboarding.searching_host": "Connecting to Antonic Agent server...",
  ...
  "onboarding.start": "Start Antonic Agent",
  ...
  "onboarding.windows_install_instruction": "Install OpenCode for Windows, then restart Antonic Agent. Ensure opencode.exe is on PATH.",
  ...
  "onboarding.cli_install_commands": "Install OpenCode with one of the commands below, then restart Antonic Agent.",
  ...
  "onboarding.remote_workspace_title": "Connect to Antonic Agent server",
  "onboarding.remote_workspace_description": "Connect to an Antonic Agent server to access a worker from anywhere.",
  "onboarding.remote_workspace_action": "Connect",
  "onboarding.remote_workspace_card_title": "Connect a remote worker",
  "onboarding.remote_workspace_card_description": "Connect to an Antonic Agent server to access a shared worker.",
  "onboarding.advanced_openwork_host": "Antonic Agent server",
  ...
  "onboarding.welcome_title": "How would you like to run Antonic Agent today?",
  "onboarding.run_local": "Run locally",
  "onboarding.run_local_description": "Antonic Agent runs OpenCode locally and keeps your work private.",
  ...
  "onboarding.default_workspace_path": "~/Antonic Agent/Worker",
  ...
  "app.migration.restart_failed": "Migration completed, but Antonic Agent could not restart the local engine.",
