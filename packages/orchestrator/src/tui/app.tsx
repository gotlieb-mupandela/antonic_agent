...
const serviceCycle = ["all", "antonic-agent-orchestrator", "opencode", "antonic-agent-server", "router"];
          ...
          <Show when={state.view === "overview"}>
            <box flexDirection="row" gap={4} paddingTop={1}>
              ...
              <box width={Math.floor(dimensions().width / 2) - 4} flexDirection="column" gap={1}>
                ...
                <text fg={theme.textMuted}>Antonic Agent URL (LAN)</text>
                <text fg={theme.text}>{state.connect.antonic-agentUrl}</text>
                <text fg={theme.textMuted}>Antonic Agent Token</text>
                <text fg={theme.text}>{state.connect.antonic-agentToken}</text>
