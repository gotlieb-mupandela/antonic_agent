...
function setCors(res) {
  ...
  res.setHeader(
    ...
    "Content-Type,Accept,X-Antonic Agent-Bundle-Type,X-Antonic Agent-Schema-Version,X-Antonic Agent-Name",
  );
}
...
export default async function handler(req, res) {
  ...
  const baseUrl = normalizeBaseUrl(getEnv("PUBLIC_BASE_URL", "https://share.antonic-agent.software"));
