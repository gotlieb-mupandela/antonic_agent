# Antonic Agent Repo Non-Stub Render E2E Proof

This directory captures end-to-end proof for the Antonic Agent-repo implementation of the Den control plane and worker provisioning flow.
