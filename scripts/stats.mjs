...
const POSTHOG_DISTINCT_ID = process.env.POSTHOG_DISTINCT_ID || "antonic-agent-download"
const GITHUB_REPO = process.env.GITHUB_REPO || "Apnium Technology/antonic-agent"
...
async function fetchReleases() {
  ...
  const headers = {
    ...
    "User-Agent": "antonic-agent-download-stats",
  }
